 ...
 */
final class Version20241208075644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A64C9C96F2 FOREIGN KEY (id_animal) REFERENCES animal (id_animal)');
